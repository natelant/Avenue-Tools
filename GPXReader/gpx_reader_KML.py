...
def main():
    ...
    intersection_file = "GPXReader/data/2100 N simple.kml" # input("Enter the file path to the significant intersections CSV or KML file: ") 
    folder_path = "GPXReader/data" #input("Enter the folder path to the GPX files: ")
    output_file = "GPXReader/output/memorialday_kml_tests.csv" #input("Enter the name of the output CSV file (i.e. output/AM_before.csv): ")
